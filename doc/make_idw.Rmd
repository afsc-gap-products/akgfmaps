...
Another object in the list is a extrapolation grid (a 'stars' object) which can be used to make plots outside of akgfmaps, but also retains the crs for plotting.
...
If the desired size for the map is not pre-defined, the \code{change_text_size()} function can be used resize plot text prior to creating a map.
