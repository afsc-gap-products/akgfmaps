...
#' @param show.plot Should the plot be shown in the device?
...
change_fill_color <- function(x, 
  ...
  if(new.scheme[1] %in% c("grey", "gray")) {
    ...
    if(new.scheme[1] == "red") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=10, c1=85, l1=25, l2=100, p1=1.3)}
    if(new.scheme[1] == "green") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=135, c1=45, l1=35, l2=100, p1=1.3)}
    if(new.scheme[1] == "aqua") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=-168, c1=45, l1=45, l2=100, p1=1.3)}
    if(new.scheme[1] == "magenta") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=-37, c1=78, l1=36, l2=100, p1=1.3)}
    if(new.scheme[1] == "tan") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=60, c1=68, l1=52, l2=100, p1=1.3)}
    if(new.scheme[1] == "blue2") {new.scheme <- colorspace::sequential_hcl(n=in.dat$n.breaks, h1=260, h2=220, c1=45, c2=5, cmax=180, l1=25, l2=100, p1=1.2, p2=1.3)}
