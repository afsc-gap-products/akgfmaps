...
interp_2d_grid <- function(x,
  ...
  png(filename = paste0("./plots/diagnostics/2d_grid_", par_name, "_", sel_year, "_fit_transform.png"),
      width = 7,
      height = 7,
      units = "in",
      res = 300)
...
interp_3d_grid <- function(x,
  ...
  png(filename = paste0("./plots/diagnostics/3d_grid_", par_name, "_", sel_year, "_fit_transform.png"),
      width = 7,
      height = 7,
      units = "in",
      res = 300)
