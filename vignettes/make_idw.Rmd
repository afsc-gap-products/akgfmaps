...
The extrapolation.grid is a data frame that contains coordinates, layer continuous values, and discrete values that can be used to make plots outside of akgfmaps.

```{r}
head(opt1$extrapolation.grid)
```
